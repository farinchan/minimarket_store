                            ...
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="jenis_kelamin" data-control="select2"
                                        ...
                                        class="form-select form-select-solid fw-bold" required>
                                        <option></option>
                                        <option value="L" @if ($user->pegawai?->jenis_kelamin == 'L') selected @endif>Laki-Laki
                                        </option>
                                        <option value="P" @if ($user->pegawai?->jenis_kelamin == 'P') selected @endif>Perempuan
                                        </option>
                                    </select>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class=" fw-semibold fs-6 mb-2">Alamat</label>
                                    <textarea name="alamat" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Alamat Pegawai">{{ $user->pegawai?->alamat }}</textarea>
                                </div>
                                <div class="mb-5">
                                    <label class="required fw-semibold fs-6 mb-5">Role</label>
                                    <div class="d-flex fv-row">
