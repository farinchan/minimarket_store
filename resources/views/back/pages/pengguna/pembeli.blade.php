                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-user-table-filter="search"
                                class="form-control form-control-solid w-250px ps-13" placeholder="Cari pembeli" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <i class="ki-duotone ki-plus fs-2"></i>Tambah pembeli</button>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">Tambah pembeli</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                        <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                            data-kt-users-modal-action="close">
                                    ...
                                    <div class="modal-body px-5 my-7">
                                        ...
                                        <form id="kt_modal_add_user_form" class="form" method="POST"
                                            action="{{ route('back.pengguna.pembeli.store') }}"
                                            ...
                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text" name="name"
                                                        ...
                                                        placeholder="Nama pembeli" value="{{ old('name') }}"
                                                        required />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="email" name="email"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="emailpembeli@domain.com"
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label"
                                                                ...
                                                                <div class="text-gray-600">pembeli dengan jenis kelamin
                                                                    laki-laki</div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <textarea name="alamat"
                                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                                        placeholder="Alamat pembeli">{{ old('alamat') }}</textarea>
                                                    <!--end::Input-->
                                                </div>
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            ...
                                            <a href="#">
                                                <div class="symbol-label">
                                                    <img src="{{ $user->Pembeli?->getFoto() }}"
                                                        alt="{{ $user->Pembeli?->nama }}" />
                                                </div>
                                            </a>
                                        </div>
                                        <div class="d-flex flex-column">
                                            <a href="apps/user-management/users/view.html"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $user->Pembeli?->nama }}</a>
                                            <span>{{ $user->email }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        @if ($user->Pembeli?->jenis_kelamin == 'L')
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body px-5 my-7">
                        <!--begin::Form-->
                        <form id="kt_modal_add_user_form" class="form" method="POST"
                            action="{{ route('back.pengguna.pembeli.update', $user->id) }}"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <!--begin::Scroll-->
                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="image-input image-input-outline image-input-empty"
                                        ...
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-125px h-125px"
                                            style="background-image: url({{ $user->Pembeli?->getFoto() }});">
                                        </div>
                                        <!--end::Preview existing avatar-->
                                        <!--begin::Label-->
                                        <label
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" name="name"
                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama pembeli"
                                        value="{{ $user->Pembeli?->nama }}" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="email" name="email"
                                        class="form-control form-control-solid mb-3 mb-lg-0"
                                        placeholder="emailpembeli@domain.com" value="{{ $user->email }}" required />
                                    <!--end::Input-->
                                </div>
                                <div class="mb-5">
                                    <!--begin::Label-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input me-3" name="jenis_kelamin" type="radio"
                                                ...
                                                @if ($user->Pembeli?->jenis_kelamin == 'L') checked='checked' @endif />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                    ...
                                    <div class="d-flex fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            ...
                                            <input class="form-check-input me-3" name="jenis_kelamin" type="radio"
                                                ...
                                                @if ($user->Pembeli?->jenis_kelamin == 'P') checked='checked' @endif />
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                            <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                <div class="fw-bold text-gray-800">Perempuan</div>
                                                <div class="text-gray-600">pembeli dengan jenis kelamin perempuan</div>
                                            </label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Radio-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea name="alamat" class="form-control form-control-solid mb-3 mb-lg-0"
                                        placeholder="Alamat pembeli">{{ $user->Pembeli?->alamat }}</textarea>
                                    <!--end::Input-->
                                </div>
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
        ...
        <div class="modal fade" id="kt_modal_delete_user{{ $user->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header" id="kt_modal_add_user_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bold">Hapus pembeli</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                            aria-label="Close">
                    ...
                    <div class="modal-body px-5">
                        <!--begin::Form-->
                        <form id="kt_modal_add_user_form" class="form" method="POST"
                            action="{{ route('back.pengguna.pembeli.destroy', $user->id) }}">
                            @method('DELETE')
                            @csrf
                            <h3 class="text-center">
                                Apakah Anda Yakin Ingin Menghapus pembeli {{ $user->pembeli?->nama }} ?
                            </h3>
                            <div class="text-center pt-10">
                                <button type="reset" class="btn btn-light me-3" data-bs-dismiss="modal"
                                    aria-label="Close">batal</button>
