...
@section('content')
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex mb-4">
                                                    <button class="btn btn-sm btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#resi{{ $pesanan->id_pemesanan }}">
                                                        Kirim Pesanan &nbsp; <i class="bi bi-box-arrow-up-right"></i>
                                                    </button>
    ...
    @foreach ( $list_transaksi as $pesanan )

    <div class="modal fade" id="resi{{ $pesanan->id_pemesanan }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{ route('back.pesanan.diproses.kirim', $pesanan->id_pemesanan) }}">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body py-5">
                        <div class="mb-3">
                            <label for="resi_pengiriman" class="form-label fw-bold">No Resi</label>
                            <input type="text" class="form-control" name="resi_pengiriman" id="resi_pengiriman" required>
                        </div>
                    </div>
