    ...
    <div class="card-header pt-5">
        ...
        <div class="card-title d-flex flex-column">
            ...
            <div class="d-flex align-items-center">
                ...
                <!--begin::Amount-->
                <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">{{ $transaksi_item_count }}</span>
                <!--end::Amount-->
                <!--begin::Badge-->
            ...
            <!--end::Info-->
            <!--begin::Subtitle-->
            <span class="text-gray-500 pt-1 fw-semibold fs-6">Item Terjual</span>
            <!--end::Subtitle-->
        </div>
        <!--end::Title-->
    </div>
    ...
    <div class="card-body d-flex align-items-end pt-0">
        ...
        <div class="d-flex align-items-center flex-column mt-3 w-100">
            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                <span class="fw-bolder fs-6 text-gray-900">{{ $transaksi_item_count }} to Goal</span>
